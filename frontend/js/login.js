        ...
        fetch("../../backend/api/UserAPI.php?action=login", {
            ...
            .then((data) => {
                ...
                if (isExist === "true") {
                    ...
                    document.querySelector("#login-form #error-message").innerHTML = "Username hoặc password không chính xác"
                }
            })
            .catch((error) => {
                console.log(error)
        ...
        if (isEqualsPasswordAndCfPassword()) {
            ...
            fetch("../../backend/api/UserAPI.php?action=addUser", {
                ...
                .then((data) => {
                    ...
                    if (!data.success) {
                        document.querySelector("#register-form #error-message").innerHTML = data.message;
                    } else {
            ...
            document.querySelector("#register-form #error-message").innerHTML = "Nhập lại mật khẩu và mật khẩu phải trùng nhau";
        }
