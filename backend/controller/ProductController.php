...
class ProductController {
    ...
    public function updateProduct($id , $name, $price, $description, $brand,$gender, $notes = [] ,  ){
        return $this->productModel->updateProduct($id ,$name, $price, $description,  $brand,$gender ,$notes );
    }
